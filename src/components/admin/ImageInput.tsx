  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="inline-flex p-1 bg-elev rounded-lg">
          <button
            type="button"
            onClick={() => setTab('upload')}
            className={`px-2.5 py-1 rounded-md text-[11px] font-bold transition-all flex items-center gap-1.5 ${tab === 'upload' ? 'bg-white text-primary shadow-sm border border-border' : 'text-ink-muted hover:text-ink-muted'}`}
          >
          ...
          <button
            type="button"
            onClick={() => setTab('url')}
            className={`px-2.5 py-1 rounded-md text-[11px] font-bold transition-all flex items-center gap-1.5 ${tab === 'url' ? 'bg-white text-primary shadow-sm border border-border' : 'text-ink-muted hover:text-ink-muted'}`}
          >
      ...
      {tab === 'upload' ? (
        <div
          ...
          className="block border-2 border-dashed border-rule hover:border-primary bg-elev hover:bg-primary-soft/30 rounded-lg p-4 cursor-pointer transition-colors text-center"
        ...
        >
          ...
          {uploading ? (
            ...
            <>
              <Upload className="w-5 h-5 text-ink-faint mx-auto mb-1.5" />
        ...
        <input
          ...
          className="w-full bg-white border border-border rounded-lg px-3 py-2 text-xs font-mono focus:outline-none focus:border-primary"
      ...
      {previewSrc && !error && (
        <div className="relative inline-block group">
          <div
            className="bg-elev border border-border rounded-md overflow-hidden"
